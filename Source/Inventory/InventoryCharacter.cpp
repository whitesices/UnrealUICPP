...
void AInventoryCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AInventoryCharacter::Look);
...
void AInventoryCharacter::DoMove(float Right, float Forward)
{
...
void AInventoryCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AInventoryCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AInventoryCharacter::DoJumpEnd()
{
